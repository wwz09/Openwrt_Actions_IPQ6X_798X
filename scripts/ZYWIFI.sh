...
# git_sparse_clone master  https://github.com/coolsnowwolf/openwrt package/lean/vlmcsd
...
git_sparse_clone openwrt-18.06  https://github.com/rosywrt luci-theme-rosy
