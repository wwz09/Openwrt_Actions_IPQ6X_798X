...
sed -i '/set wireless.default_radio${devidx}.encryption=psk2/a\set wireless.default_radio${devidx}.key=abc5124937,' ./package/network/config/wifi-scripts/files/lib/wifi/mac80211.sh
