...
# 修改 device 设备名称
sed -i "s/LibWrt/Qihoo V6/g" package/base-files/files/bin/config_generate
...
# 修改 wifi 无线名称 & 密码
sed -i "s/LiBwrt/YM520/g" target/linux/qualcommax/base-files/etc/uci-defaults/990_set-wireless.sh
sed -i "s/12345678/abc5124937,/g" target/linux/qualcommax/base-files/etc/uci-defaults/990_set-wireless.sh
