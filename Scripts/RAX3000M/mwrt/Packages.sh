...
## 添加额外插件
git_sparse_clone IMM https://github.com/wwz09/LEDE-IMM-package quickstart ucl upx  ddnsto filebrowser lua-maxminddb  smartdns upx-static docker lucky luci-lib-xterm  luci-lib-iform
