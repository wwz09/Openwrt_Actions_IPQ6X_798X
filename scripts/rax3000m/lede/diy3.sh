...
git_sparse_clone master https://github.com/kiddin9/openwrt-packages luci-app-parentcontrol luci-app-samba4
git_sparse_clone main https://github.com/kenzok8/jell autoshare-samba
...
#修改默认无线名称
sed -i 's/OpenWrt/BM520/g' package/kernel/mac80211/files/lib/wifi/mac80211.sh
